...
if( !class_exists( 'MultifoxPlusH1Settings' ) ) {
    class MultifoxPlusH1Settings {
        ...
        function __construct() {
            ...
            $this->selector = apply_filters( 'multifox_h1_selector', array( 'h1' ) );
            $this->settings = multifox_customizer_settings('h1_typo');

            add_filter( 'multifox_plus_customizer_default', array( $this, 'default' ) );
            add_action( 'customize_register', array( $this, 'register' ), 20);

            add_filter( 'multifox_h1_typo_customizer_update', array( $this, 'h1_typo_customizer_update' ) );
        ...
        function register( $wp_customize ) {
            ...
            $wp_customize->add_section(
                new Multifox_Customize_Section(
                    ...
                    'site-h1-section',
                    array(
                        'title'    => esc_html__('H1 Typograpy', 'multifox-plus'),
             ...
             */
                $wp_customize->add_setting(
                    MULTIFOX_CUSTOMISER_VAL . '[h1_typo]', array(
                        'type'    => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    new Multifox_Customize_Control_Typography(
                        $wp_customize, MULTIFOX_CUSTOMISER_VAL . '[h1_typo]', array(
                            'type'    => 'mfx-typography',
                            'section' => 'site-h1-section',
                            'label'   => esc_html__( 'H1 Tag', 'multifox-plus')
                        )
                    )
                );
             ...
             */
                $wp_customize->add_setting(
                    MULTIFOX_CUSTOMISER_VAL . '[h1_color]', array(
                        'default' => '',
                        'type'    => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    new WP_Customize_Color_Control(
                        $wp_customize, MULTIFOX_CUSTOMISER_VAL . '[h1_color]', array(
        ...
        function h1_typo_customizer_update( $defaults ) {
            $h1_typo = multifox_customizer_settings( 'h1_typo' );
            if( !empty( $h1_typo ) ) {
                return  $h1_typo;
            }
            return $defaults;
        ...
        function base_style( $style ) {
            $css   = '';
            $color = multifox_customizer_settings('h1_color');
...
MultifoxPlusH1Settings::instance();