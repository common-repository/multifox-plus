( function( $ ) {
	...
	var dtBlogPosts = function($scope, $) {
		...
		$scope.find('.mfx-posts-list-wrapper.swiper-container').each(function() {
			...
			if(carouselbulletpagination) {
				var pagination_class = $swiperItem.find('.mfx-products-bullet-pagination');
			...
			if(carouselscrollbar) {
				scrollbar_class = $swiperItem.find('.mfx-products-scrollbar');
			...
			if(arrowpagination) {
				...
				$swiperItem.find('.mfx-products-arrow-pagination .mfx-products-arrow-prev').on('click', function(e) {
				...
				$swiperItem.find('.mfx-products-arrow-pagination .mfx-products-arrow-next').on('click', function(e) {
					var swiperUniqueId = $swiperItem.attr('id');
		...
		$scope.find('.mfx-posts-list-wrapper').each(function() {
            ...
            $('.mfx-posts-list-wrapper').on( "click", ".loadmore-elementor-btn.more-items", function() {
    ...
    $(window).on('elementor/frontend/init', function(){
		elementorFrontend.hooks.addAction('frontend/element_ready/mfx-blog-posts.default', dtBlogPosts);
    });
