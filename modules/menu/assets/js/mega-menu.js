...
/*        var $window = $(window),
        ...
        $( window ).on( 'scroll', function(){
            ...
            if(0 < st) {
                $("#header-wrapper .sticky-header-active").addClass('mfx-header-top');
            } else {
                $("#header-wrapper .sticky-header-active").removeClass('mfx-header-top');
            }

            if ( st < lastScrollTop || $window.width() < 992){
                if(0 === st) {
                    $("#header-wrapper .sticky-header-active").removeClass('mfx-header-scroll');
                } else {
                    $("#header-wrapper .sticky-header-active").removeClass('mfx-header-scroll');
                    ...
                    if(parseInt($initiate_scroll_position, 10) <= parseInt(st, 10)) {
                        $("#header-wrapper .sticky-header-active").addClass('mfx-header-scroll');
