wp.customize.controlConstructor['mfx-typography'] = wp.customize.Control.extend({
	ready: function(){
		'use strict';
		var control = this,
	...
	initControl: function() {
		...
		// Font Size Input
		this.container.find(".font-size input.mfx-responsive-input").each(function(){
		...
		// Font Size Unit
		this.container.find(".font-size select.mfx-responsive-select").each(function(){
			var $input = jQuery( this );
		...
		// Line Height Unit
		this.container.find(".line-height select.mfx-responsive-select").each(function(){
			var $input = jQuery( this );
		...
		this.container.find(".letter-spacing input.mfx-responsive-input").each(function(){
			var $input = jQuery( this );
		...
		// Letter Spacing Unit
		this.container.find(".letter-spacing select.mfx-responsive-select").each(function(){
			var $input = jQuery( this );
	...
	setWeight: function( control, weights, selected = '' ) {
		...
		var $inherit = jQuery('<option></option>').attr("value", "inherit" ).text( multifoxPlusTypoObject.inherit );
		$select.append( $inherit );

		jQuery.each( weights, function( index, option ){

			var $option = jQuery('<option></option>').attr("value", option ).text( multifoxPlusTypoObject[option] );
