(function($) {
    ...
    api.bind('pane-contents-reflowed', function() {
        ...
        api.section.each(function(section) {
            ...
            if ( 'multifox_extended_section' !== section.params.type || 'undefined' === typeof section.params.section ) {
        ...
        api.panel.each(function(panel) {
            ...
            if ( 'multifox_extend_panel' !== panel.params.type || 'undefined' === typeof panel.params.panel ) {
    ...
    wp.customize.Panel = wp.customize.Panel.extend({
        ...
        attachEvents: function() {
            ...
            if ( 'multifox_extend_panel' !== this.params.type || 'undefined' === typeof this.params.panel ) {
        ...
        isContextuallyActive: function() {
            ...
            if ( 'multifox_extend_panel' !== this.params.type ) {
    ...
    wp.customize.Section = wp.customize.Section.extend({
        ...
        attachEvents: function() {
            ...
            if ( 'multifox_extended_section' !== this.params.type || 'undefined' === typeof this.params.section ) {
        ...
        isContextuallyActive: function() {
            ...
            if ( 'multifox_extended_section' !== this.params.type ) {
...
jQuery( document ).ready( function($){
    ...
    $( '.customize-control .mfx-responsive-switchers button' ).on( 'click', function( event ) {

        // Set up variables
        var $this       = $( this ),
            $devices    = $( '.mfx-responsive-switchers' ),
    ...
    $( '.wp-full-overlay-footer .devices button' ).on( 'click', function( event ) {
        ...
        // Set up variables
        var $this       = $( this ),
            $devices    = $( '.customize-control.has-responsive-switchers .mfx-responsive-switchers' ),
            $device     = $( event.currentTarget ).data( 'device' ),
            $control    = $( '.customize-control.has-responsive-switchers' );
